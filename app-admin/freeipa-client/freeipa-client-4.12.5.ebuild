...
PATCHES=(
	"${FILESDIR}/freeipa-client-4.12.5-gentoo_openrc-platform.patch"
	"${FILESDIR}/freeipa-client-4.12.5-pyca44-noTripleDES.patch"
	"${FILESDIR}/freeipa-client-4.12.5-pyca44-nox509.Certificate.patch"
	"${FILESDIR}/freeipa-client-4.12.5-packaging.patch"
)
